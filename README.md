...
A picture of the pivot table created, which uses only Kickstarter theater data, can be seen below.  It was necessary to filter the data further by removing "live" plays from the table.    
